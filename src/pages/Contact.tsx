...
const Contact = () => {
  ...
  const onSubmit = async (data: ContactForm) => {
    ...
    try {
      await fetch(
        "https://web.postman.co/workspace/01830592-de58-4b63-8780-3b72a4e68e8b/llm-request/create?requestId=6f05e915-9de2-4602-b5b8-482bbf2b4ef8",
        {
          method: "POST",
          headers: {
      ...
      console.error("Error sending to Postman:", error);
    }
  };
